    ...
    >
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <div className="lh-1">
            <h6 className="fw-medium text-dark mb-0">Manual Order</h6>
            <span
        ...
        <div className="d-none d-md-block" style={{ minWidth: "250px" }}>
          <div
            className="d-flex align-items-center bg-light border rounded-pill px-3 py-1 w-100"
            style={{ height: "50px" }}
          >
      ...
      {/* Mobile Collapsible Inputs & Search */}
      <div
      ...
      >
        <div className="d-flex flex-column gap-2">
          ...
          {/* Search */}
          <div className="d-flex align-items-center bg-light rounded-pill px-3 py-2 w-100 border-0">
            <i className="bi bi-search text-secondary me-2"></i>
            <input
              type="text"
...
export default ManualOrderHeader;

...
export default function ChickenSectionCard ({ data, isLoading = false, viewed = false }){
              ...
              <>
                ...
                {products.length > 5 && (
                  <div className="sp-product-box">
                    <Link to="/all-products?category=chicken" className="sp-product-card view-all-card" style={{ textDecoration: 'none' }}>

...
export default function MarinatedFishCard ({ data, isLoading = false, viewed = false }){
              ...
              <>
                ...
                {products.length > 5 && (
                  <div className="sp-product-box">
                    <Link to="/all-products?category=ready-to-cook" className="sp-product-card view-all-card" style={{ textDecoration: 'none' }}>

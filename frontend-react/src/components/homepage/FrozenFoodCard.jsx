...
export default function FrozenFoodCard({ data, isLoading = false, viewed = false }) {
  ...
  const displayProducts = frozenProducts
              ...
              <>
                ...
                {frozenProducts.length > 0 && (
                  <div className="sp-product-box">
                    <Link to="/categories/frozen-sea-fish/" className="sp-product-card view-all-card" style={{ textDecoration: 'none' }}>
